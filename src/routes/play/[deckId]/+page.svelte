...
{:else}
  <div class="play-container animate-fade-in">
    ...
    <div class="top-bar">
      <a href="/explore" class="close-btn" aria-label="Exit session">✕</a>
    ...
    <div class="flip-hint">
      <svg class="flip-arrow-icon" viewBox="0 0 24 24" width="24" height="24">
        <path fill="currentColor" d="M19 8l-4 4h3c0 3.31-2.69 6-6 6-1.01 0-1.97-.25-2.8-.7l-1.46 1.46C8.97 19.54 10.43 20 12 20c4.42 0 8-3.58 8-8h3l-4-4zM6 12c0-3.31 2.69-6 6-6 1.01 0 1.97.25 2.8.7l1.46-1.46C15.03 4.46 13.57 4 12 4c-4.42 0-8 3.58-8 8H1L5 16l4-4H6z"/>
      </svg>
    ...
    <div class="bottom-bar">
      ...
      <div class="swipe-buttons">
        <button class="action-btn incorrect-btn" onclick={handleSwipeLeft}>
          ✕ Incorrect
        </button>
        <button class="action-btn correct-btn" onclick={handleSwipeRight}>
          ✓ Correct
        </button>
      </div>
    </div>
